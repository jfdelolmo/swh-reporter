...
public class SwhMapper {
    ...
    public User organizationMemberToUser(OrganizationMember organizationMember) {
        User user = new User();

        user.setUserId(organizationMember.getUserId());
        user.setUsername(organizationMember.getUsername());
        user.setEmail(organizationMember.getEmail());
        user.setFirstName(organizationMember.getFirstName());
        user.setLastName(organizationMember.getLastName());
        user.setRole(organizationMember.getRole());
        user.setInviteTime(organizationMember.getInviteTime());
        user.setStartTime(organizationMember.getStartTime());
        user.setLastActive(organizationMember.getLastActive());
